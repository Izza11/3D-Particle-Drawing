...
GLuint InitShader(const char* vShaderFile, const char* fShaderFile)
{
   ...
   for ( int i = 0; i < 2; ++i ) 
   {
	  ...
	  if (i == 0) {    // if vertex shader
					   //transform feedback
		  const char * outputNames[] = { "outPosition" , "partOutTime", "partOutPlaced", "partOutFade" };
		  glTransformFeedbackVaryings(program, 4, outputNames, GL_SEPARATE_ATTRIBS);
	  }
   }
...
GLuint InitShader2(const char* vShaderFile, const char* fShaderFile)
{
